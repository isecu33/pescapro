/* Genera datos sinteticos con la misma forma que PP.api.fusionar() (hoy
   src/domain/api.js). Compartido por los tests de mareas/indice/especies/
   records, igual que test/fixtures.js en la version vanilla. */
export function generarDatos(opts) {
